...
namespace L01P02_2020NR601.Controllers
{
    public class pedidosController : Controller
    {
        ...
        public async Task<IActionResult> Create([Bind("pedidoId,motoristaId,clienteId,cantidad")] pedidos pedidos)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(int id, [Bind("pedidoId,motoristaId,clienteId,cantidad")] pedidos pedidos)
        {
